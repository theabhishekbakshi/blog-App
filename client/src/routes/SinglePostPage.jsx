      ...
      <div className="flex gap-8 ">
        <div className="lg:w-3/5 flex flex-col gap-8 ">
          <h1 className="text-xl md:text-3xl xl:w-4xl 2xl:text-5xl font-semibold">
            ...
            perspiciatis praesentium voluptas.
          </h1>
          ...
          <p className="text-gray-500 font-medium">
            ...
            rerum est ab ipsum aut deleniti praesentium. Sed ab soluta in! Lorem
            ipsum dolor sit amet consectetur adipisicing elit. Officia vitae
            debitis nemo.
          </p>
        </div>
        <div className="hidden lg:block w-2/5 m-3">
          <MyImage src="postImg.jpeg" className="rounded-2xl" />
        </div>
      </div>
      {/* Content */}
